...
%% 30-Dec: V2.3 - Dataset variability
...
\begin{document}
	...
	\subsubsection*{Network architecture and basic hyperparameters}
	...
	%% $$$ R2-4 Novelty
	\hlc{In} \cite{Eimer2023AutoRL}, \citeauthor{Eimer2023AutoRL} \hlc{highlight the importance of our research by stating that it is especially important for ``as-of-yet unexplored domains''}
	...
	%% $$$ R1-4 Limitations
	\subsection{\hlc{Limitations of our research}}
